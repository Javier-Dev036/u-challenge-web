                    ...
                    <div className="relative flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <div className={`absolute right-1 mt-64 z-50 ${isDropdownOpen ? 'block' : 'hidden'} my-4 text-base list-none border bg-white divide-y divide-gray-100 rounded-lg shadow-lg`} id="user-dropdown">
                            ...
                            <ul className="py-2" aria-labelledby="user-menu-button">
                                <li>
                                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-200">Inicio</a>
                                </li>
                                <li>
                                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-200">Calificaciones</a>
                                </li>
                                <li>
                                    <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-200">Cerrar sesión</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                        <h1 className='block py-2 px-3 text-black text-2xl font-bold'>
                            Bienvenido <span className='text-blue-500'>"Javier Hau"</span>
                        </h1>
                    </div>
                </div>
            </nav>
